    ...
    <View style={styles.container}>
      ...
      <View style={styles.statperfil}>
        ...
        <View>
          ...
          <Text style={styles.botao}>Cidade: Campina Grande</Text>
          <Text style={styles.botao}>Estado: Paraiba</Text>
          <Text style={styles.botao}>Rua: seila</Text>
          <Text style={styles.botao}>Número: 17</Text>
        </View>
      </View>
    </View>
  );
